# Generated by Django 5.2.3 on 2025-07-23 19:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='myapp/blog_images/default.jpg', help_text='Imagen del blog', upload_to='myapp/blog_images/')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blogs', to='myapp.category')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
